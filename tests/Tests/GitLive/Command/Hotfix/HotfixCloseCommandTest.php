...
class HotfixCloseCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->assertEquals([
            ...
            26 => "git format-patch master..deploy/hotfix/unit_test_deploy --stdout",
            27 => "git merge deploy/hotfix/unit_test_deploy",
            28 => "git diff deploy/hotfix/unit_test_deploy master",
            ...
            35 => "git merge deploy/hotfix/unit_test_deploy",
            36 => "git push upstream staging",
            37 => "git push deploy :hotfix/unit_test_deploy",
            38 => "git push upstream :hotfix/unit_test_deploy",
            39 => "git branch -d hotfix/unit_test_deploy",
            40 => "git fetch upstream",
            41 => "git checkout upstream/master",
            42 => "git tag runit_test_deploy",
            43 => "git push upstream --tags",
