...
class ReleaseCloseCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->assertEquals([
            ...
            26 => "git format-patch master..deploy/release/unit_test_deploy --stdout",
            27 => "git merge deploy/release/unit_test_deploy",
            28 => "git diff deploy/release/unit_test_deploy master",
            29 => "git push upstream master",
            30 => "git push deploy master",
            31 => "git checkout upstream/staging",
            32 => "git branch -D staging",
            33 => "git checkout -b staging",
            34 => "git symbolic-ref HEAD 2> /dev/null",
            35 => "git merge deploy/release/unit_test_deploy",
            36 => "git diff deploy/release/unit_test_deploy staging",
            37 => "git push upstream staging",
            38 => "git push deploy :release/unit_test_deploy",
            39 => "git push upstream :release/unit_test_deploy",
            40 => "git branch -d release/unit_test_deploy",
            41 => "git fetch upstream",
            42 => "git checkout upstream/master",
            43 => "git tag runit_test_deploy",
            44 => "git push upstream --tags",
